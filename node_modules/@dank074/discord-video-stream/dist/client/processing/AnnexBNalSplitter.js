...
const AnnexBHelper_1 = require("./AnnexBHelper");
 ...
 */
class AnnexBNalSplitter extends stream_1.Transform {
    constructor() {
        super(...arguments);
        this._accessUnit = [];
    }
...
class H264NalSplitter extends AnnexBNalSplitter {
    ...
    removeEpbs(frame, unitType) {
        if (unitType === AnnexBHelper_1.H264NalUnitTypes.SPS || unitType === AnnexBHelper_1.H264NalUnitTypes.SEI)
