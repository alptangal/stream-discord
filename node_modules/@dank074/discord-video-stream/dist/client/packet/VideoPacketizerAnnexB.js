...
const AnnexBHelper_1 = require("../processing/AnnexBHelper");
/**
 * Annex B format
 *
 ...
 * produced correspond to packetization-mode=1.
         ...
         ...
 */
class VideoPacketizerAnnexB extends BaseMediaPacketizer_1.BaseMediaPacketizer {
...
class VideoPacketizerH264 extends VideoPacketizerAnnexB {
    constructor(connection) {
        super(connection);
        this._nalFunctions = AnnexBHelper_1.H264Helpers;
    }
    /**
 ...
 */
    makeFragmentationUnitHeader(isFirstPacket, isLastPacket, naluHeader) {
        ...
        const nalType = AnnexBHelper_1.H264Helpers.getUnitType(naluHeader);
...
class VideoPacketizerH265 extends VideoPacketizerAnnexB {
    constructor(connection) {
        super(connection);
        this._nalFunctions = AnnexBHelper_1.H265Helpers;
    }
    /**
     * The FU indicator octet has the following format:
 ...
 */
    makeFragmentationUnitHeader(isFirstPacket, isLastPacket, naluHeader) {
        ...
        const nalType = AnnexBHelper_1.H265Helpers.getUnitType(naluHeader);
